...
<div id="nagivatorDiv">
    <ul class="layui-nav layui-bg-green">
        ...
        <li class="layui-nav-item"><a href="/encryption/desktopServer/comparison.jsp" v-show="alreadyLogin" target="myiframe">对比</a></li>
        <%--<li class="layui-nav-item"><a href="">留学圈</a></li>--%>
        <li class="layui-nav-item">
            <a href="/encryption/desktopServer/resourceCenter.jsp" target="myiframe">申请档案馆</a>
        </li>
