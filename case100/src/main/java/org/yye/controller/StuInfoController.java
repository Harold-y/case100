...
public class StuInfoController {
    ...
    {
        int checked = stuInfoService.StuInfoLogin(stuemail,stupassword);
        if(checked == 1)
        {
            Map map1 = selectStuInfoGeneralInfo(stuemail,stupassword);
    ...
    @ResponseBody
    public StuInfo selectById(HttpSession session)
    {
        Integer stuId = (Integer)session.getAttribute("stuId");
        return stuInfoService.selectStuInfoById(stuId);
    }
