...
<div id="nagivatorDiv">
    <ul class="layui-nav layui-bg-green">
        ...
        <li class="layui-nav-item" v-show="alreadyLogin">
            <a href="/encryption/desktopServer/personalCenter.jsp" target="myiframe" onclick="changeFrameHeight3()">个人中心<span class="layui"></span></a>
        </li>



        <li class="layui-nav-item" style="float: right">
            <a href="/encryption/desktopServer/signin.jsp" target="myiframe" v-show="!alreadyLogin" onclick="changeFrameHeight5()">登录</a>
        </li>
        <li class="layui-nav-item" style="float: right">
            <a href="/encryption/desktopServer/signup.jsp" target="myiframe" v-show="!alreadyLogin" onclick="changeFrameHeight5()">注册</a>
        </li>
...
<hr class="layui-bg">
<div id="returning" style="height:55px; width:101.5%; margin-left:-30px; border-bottom:4px solid #ffd400;">
    <input type="button" id="return" value="返回顶部" onclick="window.location.href='#';return false">
</div>
<style>
    #return{
        float:right;
